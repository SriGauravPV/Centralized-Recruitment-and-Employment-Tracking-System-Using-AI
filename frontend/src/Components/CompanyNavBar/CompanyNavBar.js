...
const CompanyNavBar = () => {
  ...
  const navItems = [
    { label: 'Dashboard', path: '/home/CompanyDashboard' },
    // { label: 'Post Drive', path: '/home/postDrive' },
    { label: 'Resume Database', path: '/home/studentDatabase' },
    { label: 'Final Selects', path: '/home/FinalSelect' }
  ];
